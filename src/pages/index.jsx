            ...
            <Container className="mt-9">
                <div className="max-w-2xl">
                    ...
                    <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
                        I&aposm Richard, a data scientist and visualization engineer at Netflix. I&aposm passionate
                        about empowering businesses in making better decisions and achiving their goals through

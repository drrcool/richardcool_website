...
author: 'Richard Cool',
date: '2023-04-08',
title: 'Technical debt: How do you stay ahead of it, guard from it, manage it, and not get swallowed by it.',
description:"Technical debt is a byproduct of all design, but comes to play especially in fast moving environments where delivery may be more important than perfect execution. Things like refactoring, restructing, etc are made more problematic when there's heft debt to pay.",
}

export default (props) => <ArticleLayout meta={meta} {...props} />

Technical debt is a byproduct of all design, but comes to play especially in fast moving environments where delivery may be more important than perfect execution. Things like refactoring, restructing, etc are made more problematic when there's heft debt to pay.

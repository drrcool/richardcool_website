...
export const meta = {
author: 'Richard Cool', date: '2023-04-08',
title: 'Editor Wars: My never-ending search for the perfect developing environment',
description:
"I describe my trials and tribulations around choosing the ideal development environment for my work.",
}

export default (props) => <ArticleLayout meta={meta} {...props} />

I've found myself on a seemingly endless marry-go-round of editors lately. Emacs, VS Code, Neovim, and Webstorm have all been major players in my professional development life. What have I settled on? Why? What do I see as the strengths of each option? Come find out and show me what other great tools I may be missing.
